...
public partial class CustomLoading : Grid
{
    ...
    public void StartAnimation()
    {
        ...
        var circling1Rotate = new Animation(v => img_purple.Rotation = v, 0, -360, Easing.Linear);
        var circling2Rotate = new Animation(v => img_green.Rotation = v, 0, 360, Easing.Linear);
        ...
        bgAnm.Add(0, 1, circling1Rotate);
        bgAnm.Add(0, 1, circling2Rotate);
